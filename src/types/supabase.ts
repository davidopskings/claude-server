	...
	public: {
		Tables: {
			...
			agent_memory: {
				...
				Relationships: [
					{
						foreignKeyName: "agent_memory_source_job_id_fkey";
			...
			client_users: {
				...
				Insert: {
					...
					client_id: string;
					contact_type?:
						| Database["public"]["Enums"]["contact_type_enum"]
						| null;
					created_at?: string | null;
					email?: string | null;
					full_name: string;
			...
			feature_initiatives: {
				...
				Relationships: [
					{
						foreignKeyName: "feature_initiatives_feature_id_fkey";
						columns: ["feature_id"];
						isOneToOne: false;
						referencedRelation: "features";
						referencedColumns: ["id"];
					...
					{
						foreignKeyName: "feature_initiatives_initiative_id_fkey";
						columns: ["initiative_id"];
						isOneToOne: false;
						referencedRelation: "initiatives";
						referencedColumns: ["id"];
		...
		Enums: {
			contact_type_enum: "job_candidate" | "client_contact" | "vendor";
		};
		CompositeTypes: {
			[_ in never]: never;
		};
